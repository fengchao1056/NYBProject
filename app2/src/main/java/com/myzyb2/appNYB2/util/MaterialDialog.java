...
public class MaterialDialog {
    ...
    private final static int BUTTON_BOTTOM = 0;
//	private final static int BUTTON_TOP = 9;

    private boolean mCancel, mFlag;
    ...
    public MaterialDialog setCancelable(boolean flag) {
        this.mFlag = flag;
        if (mBuilder != null) {
            mBuilder.setCancelable(mFlag);
        }
        return this;
    }
    ...
    private class Builder {
        ...
        private Builder() {
            ...
            int layoutId = R.layout.layout_materialdialog;
            View contv = LayoutInflater.from(mContext).inflate(layoutId, null);
...
//			WindowManager.LayoutParams params = new WindowManager.LayoutParams(WindowManager.LayoutParams.WRAP_CONTENT, WindowManager.LayoutParams.WRAP_CONTENT, WindowManager.LayoutParams.TYPE_PHONE, WindowManager.LayoutParams.FLAG_ALT_FOCUSABLE_IM, PixelFormat.TRANSLUCENT);
            ...
            mAlertDialog.setCancelable(mFlag);
