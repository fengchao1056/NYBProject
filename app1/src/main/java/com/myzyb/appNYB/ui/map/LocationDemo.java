package com.myzyb.appNYB.ui.map;
...
import com.myzyb.appNYB.ui.map.BaiduMapUtilByRacer.GeoCodePoiListener;
import com.myzyb.appNYB.ui.map.BaiduMapUtilByRacer.LocateListener;
import com.myzyb.appNYB.ui.map.BaiduMapUtilByRacer.PoiSearchListener;
        ...
        BaiduMapUtilByRacer.getPoisByGeoCode(ll.latitude, ll.longitude,
                new GeoCodePoiListener() {
                    ...
                    public void onGetSucceed(LocationBean locationBean,
                        ...
                        mProvince = mLocationBean.getProvince();
                        mCity = mLocationBean.getCity();
                        mDistrict = mLocationBean.getDistrict();
    ...
    private void iniEvent() {
        ...
        lvAroundPoi.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                LogUtil.e("dizhi", "省:" + mProvince + "市:" + mCity + "县:" + mDistrict + "X:" + aroundPoiList.get(arg2).location.latitude + "Y:" + aroundPoiList.get(arg2).location.longitude);
                ...
                intent.putExtra("mProvince", mProvince)
                        .putExtra("mCity", mCity)
                        .putExtra("mDistrict", mDistrict)
                        .putExtra("x-height", aroundPoiList.get(arg2).location.latitude)
                        .putExtra("Y-coordinate", aroundPoiList.get(arg2).location.longitude)
                        .putExtra("name", aroundPoiList.get(arg2).name);
                setResult(2, intent);
                finish();
