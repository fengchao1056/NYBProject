...
public class PasswordDialog {
    ...
    public PasswordDialog setCancelable(boolean cancel) {
        dialog.setCancelable(cancel);
        return this;
    }

    public PasswordDialog setPositiveButton(String text,
    ...
    public PasswordDialog setNegativeButton(String text,
                                            final OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(text)) {
            btn_neg.setText("取消");
